...
import nextBtn from '@/src/assets/icons/next.png'
import previousBtn from '@/src/assets/icons/previous.png'
			...
			>
				{pages.map((p) => (
					<Link
						...
						className={clsx(
							p === currentPage
								? 'pointer-events-none text-white bg-custom-blue relative inline-flex items-center border rounded-[8px] px-4 py-2 text-sm font-medium hover:bg-custom-blue hover:text-white'
								: 'relative inline-flex items-center border rounded-[8px] text-black bg-white px-4 py-2 text-sm font-medium hover:bg-custom-blue hover:text-white'
						)}
						href={`?page=${p}`}
					>
						{p}
