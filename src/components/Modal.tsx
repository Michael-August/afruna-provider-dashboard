...
const Modal: FC<ModalProps> = ({ isOpen, onClose, onCancel, onConfirm, cancelBtn, confirmBtn, children, height }) => {
    return ( 
        <>
            {isOpen &&
                <div className="modal h-full flex items-start fixed justify-center w-screen bg-black/50 z-50 backdrop-blur-sm top-0 right-0 bottom-0 transition-all duration-500 ease-in">
                    <div className="modal-content mx-5 flex flex-col justify-center items-center mt-5 ">
